...
void sgx_epc_cgroup_isolate_pages(struct sgx_epc_reclaim_control *rc,
				  struct list_head *dst)
{
        struct sgx_epc_cgroup *epc_cg, *root;
        struct sgx_epc_reclaim reclaim;
	bool do_high;
...
static inline void __sgx_epc_cgroup_reclaim_high(struct sgx_epc_cgroup *epc_cg)
{
	...
	sgx_epc_reclaim_control_init(&rc, epc_cg, 0);
					      ...
					      unsigned long nr_pages)
{
	...
	sgx_epc_reclaim_control_init(&rc, NULL, 0);
